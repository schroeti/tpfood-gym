...
class Delivery(DiscreteEnv):
    ...
    def encode(self, taxi_row, taxi_col, pass_loc_1, pass_loc_2, dest_idx_1, dest_idx_2):
        ...
        i += taxi_col
        i *= 5 # 5 number of passenger 1 locations
        i += pass_loc_1
        i *= 5 # 5 number of passenger 2 locations
        i += pass_loc_2
        i *= 4 #4 number of passenger 1 destinations
        i += dest_idx_1
        i *= 4 #4 number of passenger 2 destinations
        i += dest_idx_2
        return i
    
    def decode(self, i):
        out = []
        out.append(i % 4) #4 number of passenger 1 destinations
        i = i // 4  #4
        out.append(i % 4) #4 number of passenger 2 destinations
        i = i // 4  #4
        out.append(i % 5) #5 number of passenger 1 locations
        i = i // 5 #5
        out.append(i % 5) #5 number of passenger 2 locations
        i = i // 5 #5
