...
# =============================================================================
# 2b. Re-Training second model DQN
# =============================================================================
from stable_baselines import DQN
env = gym.make('Delivery-v0')
env.seed(42)
...
#Model 2
time_steps = 3000000
model2 = DQN('LnMlpPolicy', env,gamma=0.8, exploration_fraction = 0.664, learning_rate=1.3e-3, buffer_size=50000, verbose=1,double_q = True, prioritized_replay = True)
callback_CT = CheckTraining(check_freq = 10000, log_dir = log_dir)
...
plt.savefig('DQN_training.png', dpi=1200)
